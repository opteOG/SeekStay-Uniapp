...
if (!Array) {
  ...
  (_easycom_uni_rate2 + _component_path + _component_g + _component_rect + _component_clipPath + _component_defs + _component_svg)();
}
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return {
        a: common_vendor.t(__props.score),
        b: common_vendor.p({
          value: __props.score,
          ["active-color"]: "#c56729",
          size: "12"
        ...
        l: common_vendor.p({
          ["clip-path"]: "url(#clip0_5880_37773)"
        }),
        m: common_vendor.p({
          width: "18.8235",
          height: "32",
        ...
        z: common_vendor.p({
          ["clip-path"]: "url(#clip0_5880_37786)"
        }),
        A: common_vendor.p({
          width: "18.8235",
          height: "32",
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__scopeId", "data-v-95796f8f"]]);
wx.createComponent(Component);
//# sourceMappingURL=../../../.sourcemap/mp-weixin/components/ScoreBar/ScoreBar.js.map
